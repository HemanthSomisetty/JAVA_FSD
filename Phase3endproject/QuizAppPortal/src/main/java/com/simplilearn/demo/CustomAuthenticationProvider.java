...
public class CustomAuthenticationProvider implements AuthenticationProvider {
    ...
    public CustomAuthenticationProvider() {
        dummyUsers.add(new User("hemu", "9632", "ROLE_USER"));
        dummyUsers.add(new User("bob", "1234", "ROLE_USER"));
        dummyUsers.add(new User("raj", "8520", "ROLE_USER"));
        dummyUsers.add(new User("ravi", "7412", "ROLE_USER"));
